#!/usr/bin/env python3
"""Capture the real scheduled-post payload from LinkedIn's web client.

Injects fetch + XHR interceptors into Chrome's LinkedIn tab, then waits
for you to manually schedule a post via the composer (click the clock icon,
pick a future date/time, click "Schedule").
...
def main():
    ...
    print("\n>>> Now open the LinkedIn post composer in Chrome.")
    print(">>> Click the clock icon, pick a future date/time, and click 'Schedule'.")
